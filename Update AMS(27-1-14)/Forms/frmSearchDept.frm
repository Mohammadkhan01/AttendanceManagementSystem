...
Begin VB.Form frmSearchDept 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSearchDept.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSearchDept.frx":0452
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSearchDept.frx":08A4
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Image Image1 
      ...
      Height          =   5685
      Left            =   120
      Picture         =   "frmSearchDept.frx":117E
      Stretch         =   -1  'True
      Top             =   810
      Width           =   2325
   End
End
Attribute VB_Name = "frmSearchDept"
...
ListView1.ColumnHeaders.Add , , "Dept ID", 1500
ListView1.ColumnHeaders.Add , , "Dept Name", 4000
...
rsDept.Open "select siDeptID, vDeptName From tblDepartment Where vDeptName like '" & txtSearch & "%' Order By vDeptName Asc", CnnMain, adOpenForwardOnly, adLockReadOnly
If Not rsDept.EOF Then
    Call prc_DataShowFormat(rsDept)
    ListView1.SetFocus
Else
    ListView1.ListItems.Clear
    Frame1.Caption = "Total Department: " & ListView1.ListItems.Count
    MsgBox "Department information not found due to your search.", vbExclamation, "Remark Message"
...
Public Sub prc_DataShowFormat(rsDept As Recordset)
On Error GoTo ErrHandle:
Dim itmX As ListItem
ListView1.ListItems.Clear
If Not rsDept.EOF Then
    Do While Not rsDept.EOF
        Set itmX = ListView1.ListItems.Add(, , rsDept!siDeptID, , 3)
        itmX.SubItems(1) = rsDept!vDeptName & ""
        rsDept.MoveNext
    Loop
        Frame1.Caption = "Total Department: " & ListView1.ListItems.Count
Else
    MsgBox "Department information not found! You have to input one or more Department!", vbExclamation, "Remark Message"
    Exit Sub
End If
Set rsDept = Nothing
Exit Sub
