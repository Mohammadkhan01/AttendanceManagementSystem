   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSearchEmp.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSearchEmp.frx":0452
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSearchEmp.frx":08A4
            Key             =   ""
         EndProperty
      EndProperty
   End
...
ListView1.ColumnHeaders.Add , , "Employee ID", 2000
ListView1.ColumnHeaders.Add , , "Employee Name", 3500
...
rsAdd.Open "Select vEmployee, vEmpName From tblEmpDetails Order By vEmployee Asc", CnnMain, adOpenForwardOnly, adLockReadOnly
Dim itmX As ListItem
ListView1.ListItems.Clear
If Not rsAdd.EOF Then
    Do While Not rsAdd.EOF
        Set itmX = ListView1.ListItems.Add(, , rsAdd!vEmployee, , 3)
        itmX.SubItems(1) = rsAdd!vEmpName & ""
        rsAdd.MoveNext
    Loop
End If
Set rsAdd = Nothing
...
rsDept.Open "select vEmployee, vEmpName From tblEmpDetails Where vEmployee like '" & txtSearch & "%' Order By vEmployee Asc", CnnMain, adOpenForwardOnly, adLockReadOnly
If Not rsDept.EOF Then
    Call prc_DataShowFormat(rsDept)
    ListView1.SetFocus
Else
    ListView1.ListItems.Clear
    Frame1.Caption = "Total Employee: " & ListView1.ListItems.Count
    MsgBox "Employee information not found due to your search.", vbExclamation, "Remark Message"
...
If Not rsDept.EOF Then
    Do While Not rsDept.EOF
        Set itmX = ListView1.ListItems.Add(, , rsDept!vEmployee, , 3)
        itmX.SubItems(1) = rsDept!vEmpName & ""
        rsDept.MoveNext
    Loop
        Frame1.Caption = "Total Employee: " & ListView1.ListItems.Count
Else
    MsgBox "Employee information not found! You have to input one or more Employee!", vbExclamation, "Remark Message"
    Exit Sub
End If
Set rsDept = Nothing
Exit Sub
